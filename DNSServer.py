...
def encrypt_with_aes(input_string, password, salt):
  ...
  encrypted_data = f.encrypt(
      input_string.encode('utf-8'))  # call the Fernet encrypt method
...
password = 'as17653@nyu.edu'  #might change
input_string = 'AlwaysWatching'

encrypted_value = encrypt_with_aes(input_string, password,
                                   salt)  # test function
decrypted_value = decrypt_with_aes(encrypted_value, password,
                                   salt)  # test function
...
def run_dns_server():
  ...
  server_socket = socket.socket(socket.AF_INET,
                                socket.SOCK_DGRAM)  # Research this
